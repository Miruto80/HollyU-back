...
export const Detalle_pedido = sequelize.define('Detalle_pedido', {
  ...
  // Pedido normal (sin personalización)
  ...
  variante_id: { type: DataTypes.INTEGER }, 
...
export const associateDetalle_pedido = () => {
  const { Pedidos, Producto_variantes, Productos, Modelos, Tipos_tela, Colores, Tallas } = sequelize.models;
